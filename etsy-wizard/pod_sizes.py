...
POD_PRODUCTS = [
    ...
    {
        "id": "framed_canvas",
        "name": "แคนวาสมีกรอบ (Framed Canvas) 8x10",
        "category": "home",
        "print_area": "เต็มพื้นที่",
        "width_inch": 8,
        "height_inch": 10,
        ...
        "file_type": "JPEG / PNG",
        "max_file_size_mb": 25,
        "notes": "Canvas พร้อมกรอบไม้ สำเร็จรูป ไม่ต้องใส่กรอบเอง — Bleed 0.125 นิ้วรอบด้าน",
        "providers": ["Printful"],
        "print_technique": "Giclée",
    },
    {
    ...
    {
        "id": "framed_poster",
        "name": "โปสเตอร์มีกรอบ (Framed Poster) 11x14",
        "category": "home",
        "print_area": "เต็มพื้นที่ (in frame)",
        "width_inch": 11,
        "height_inch": 14,
        "width_px_300": 3300,
        "height_px_300": 4200,
        ...
        "file_type": "JPEG / PNG",
        "max_file_size_mb": 50,
        "notes": "Poster พร้อมกรอบไม้ + passe-partout (mat) ดูมีระดับ — ตัวกรอบเลือกสีได้",
        "providers": ["Printful"],
        "print_technique": "Giclée",
    },
    {
        "id": "metal_print",
        "name": "Metal Print (Glossy) 8x10",
        "category": "home",
        "print_area": "เต็มพื้นที่",
        "width_inch": 8,
        "height_inch": 10,
        ...
        "file_type": "JPEG / PNG",
        "max_file_size_mb": 25,
        "notes": "พิมพ์บนแผ่นอลูมิเนียมเงา สีสด คมชัด ทนน้ำ — เหมาะกับภาพถ่ายและอาร์ตเวิร์ค",
        "providers": ["Printful"],
        "print_technique": "Sublimation on metal",
    },
    {
        "id": "wall_tapestry",
        "name": "ผ้าผนัง (Wall Tapestry)",
        "category": "home",
        "print_area": "เต็มพื้นที่",
        "width_inch": 60,
        "height_inch": 40,
        ...
        "notes": "ผ้าโพลีเอสเตอร์ พิมพ์ตลอดผืน ใช้ตกแต่งผนัง หรือเป็นผ้าคลุมเตียงก็ได้",
        "providers": ["Printful"],
        "print_technique": "Sublimation on polyester",
    },
    {
        "id": "pillow_square",
