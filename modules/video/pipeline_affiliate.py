...
def _deepseek_product_prompts(product_name: str, description: str, ugc_style: str = "holding",
    ...
    try:
        ...
        sysprompt = (
            ...
            "Pick ONE specific, natural-looking adult creator and describe her/him concretely so the image model is not left to invent a random face: "
            "ethnic look (e.g. Thai / East-Asian), age, face shape (oval/round/soft jawline), clear natural eyes and brows, neat plain hair "
            "(shoulder-length or tied back, not a distracting cut), slim-normal healthy build, and a simple casual home outfit (plain tee/tank or "
            "everyday top). Aim for an ordinary, warm, believable real person — fresh and pleasant, NOT dolled-up, NOT a model-perfect face, "
            "and NOT distorted/plain-ugly. NEVER change this identity between image and video, or between first frame and later frames — same "
            "person throughout. Absolutely NO extra limbs, NO wrong finger counts, NO deformed/asymmetrical face.\n\n"
