...
def _deepseek_product_prompts(product_name: str, description: str, ugc_style: str = "holding",
    ...
    try:
        ...
        sysprompt = (
            ...
            "- THE ENDING BEAT: the final 2-3 seconds must settle cleanly ON THE PRODUCT (a stable hero hold, or "
            "the worn fit locked) - never end on a bare face/bust close-up or an empty shot.\n"
            "- Camera: vertical 9:16 smartphone, natural subtle handheld movement, crisp focus on the product as "
            "the hero. The product is clearly visible in EVERY beat of the clip - never drop it from frame.\n\n"
