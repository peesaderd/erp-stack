...
def _deepseek_product_prompts(product_name: str, description: str, ugc_style: str = "holding",
    ...
    try:
        ...
        sysprompt = (
            ...
            "and reuse the fixed identity line verbatim so image and video describe the SAME wearing/content state for the product.")
        _acted_instr = ""
...
def generate_video(
    ...
    if thai_voice_mode:
        ...
        final_prompt = (
            f"นี่คือบทพูดภาษาไทยของนาย ให้อ่านออกเสียงตามบทนี้เท่านั้น ทีละคำ ให้ชัดเจน ถูกต้องตามเสียงภาษาไทย:\n"
            f"«{thai_script}»\n"
