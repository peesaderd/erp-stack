...
def _deepseek_product_prompts(product_name: str, description: str, ugc_style: str = "holding",
    ...
    try:
        ...
        sysprompt = (
            ...
            " \"video_prompt\": \"<ONE continuous shot with start/middle/settle, grounded in physical detail, 70-110 words>\"\n"
            ...
            "3. ONE MAIN ACTION with a clear start, middle, and end (do NOT stack several separate actions). \n"
            "   Stay on that single main action but describe it in FULL physical detail - every beat is grounded. \n"
            "   End the shot on a calm, settled beat.\n"
            ...
            "TARGET LENGTH: 70-110 words, ONE paragraph, present tense. NEVER under 70 words - a short prompt \n"
