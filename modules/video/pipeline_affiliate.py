...
def _deepseek_product_prompts(product_name: str, description: str, ugc_style: str = "holding",
    ...
    try:
        ...
        sysprompt = (
            ...
            "   every beat grounded. End on a calm, settled beat.\n"
            ...
            "6. SCENE FIDELITY - use ONLY the props and setting already established in your image_prompt. NEVER \n"
            "   invent new objects, tools, or kitchenware that are not in the frame (no kettle, no chopsticks, no \n"
            "   extra bowls/pans unless the image_prompt already shows them). One simple real setup.\n"
