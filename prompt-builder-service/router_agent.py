...
- "10s" — กำลังดี ไม่ยาวไม่สั้นเกิน (แฟชั่น, เครื่องสำอาง, ของใช้ทั่วไป)
- "12s" — กำลังพอดี อธิบายได้ครบ (สินค้าที่มีจุดขายชัดเจน)
- "15s" — ต้องอธิบายเพิ่ม มีหลายประเด็น (skincare ที่ต้องอธิบายวิธีใช้, อุปกรณ์ซับซ้อน)
- "30s" — ต้องอธิบายเยอะ มีหลายขั้นตอน (skincare routine, อุปกรณ์ซับซ้อน)
...
3. ถ้าสินค้าต้องอธิบายมาก → 15s + PAS, ถ้าทั่วไป → 10s หรือ 12s
