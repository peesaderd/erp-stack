...
Output ONLY valid JSON:
{
  ...
  "container_type": "ประเภทภาชนะ/รูปทรงสินค้า (เช่น ขวดแก้วทรงกระบอก, กระปุกกลม, ตัวเครื่องไฟฟ้า)",
  "closure_type": "ลักษณะฝาปิด/ส่วนหัว (เช่น ฝาหมุนเกลียวสีขาว, หัวปั๊มทอง, ฝาพับ, ไม่มีฝา)",
  "label_colors": "สีฉลาก ตัวหนังสือ และสีบรรจุภัณฑ์หลัก",
  "product_color": "สีของเนื้อสัมผัส/เซรั่ม/เนื้อครีมด้านใน",
...
def research_product(product_name, description='', category='', image_base64=None):
    ...
    try:
        ...
        return {
            ...
            'container_type': 'ขวด/ภาชนะทรงมาตรฐาน',
            'closure_type': 'ฝาปิดมาตรฐาน',
            'label_colors': 'สีบรรจุภัณฑ์ตามภาพ',
            'product_color': 'เนื้อสัมผัสธรรมชาติ',
        }
